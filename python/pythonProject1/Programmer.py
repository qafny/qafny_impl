...
class QXTop:
    ...
    def __init__(self, line: Optional[int] = None, col: Optional[int] = None, range: Tuple[int, int] = None, source: str = None, parser_context: Optional[Union[antlr4.ParserRuleContext, antlr4.TerminalNode, 'QXTop']] = None, **kwargs):
        ...
        if parser_context is not None:
            ...
            if line is None and start_token is not None:
                line = start_token.line
            if col is None and start_token is not None:
                col = start_token.column
            if range is None and start_token is not None and end_token is not None:
...
class TyArray(QXType):
    ...
    def __init__(self, type: QXType, flag: QXAExp, **kwargs):
        super().__init__(**kwargs)
        self._type = type
        self._flag = flag
...
class TySet(QXType):
    ...
    def __init__(self, type: QXType, **kwargs):
        super().__init__(**kwargs)
        self._type = type
...
class TyFun(QXType):
    ...
    def __init__(self, parameters: [QXType], return_type: QXType, **kwargs):
        super().__init__(**kwargs)
...
class QXBind(QXAExp):
    ...
    def __init__(self, id: str, type: QXType = None, **kwargs):
        super().__init__(**kwargs)
...
class QXLogic(QXBool):
    ...
    def __init__(self, op: str, left: QXBool, right: QXBool, **kwargs):
        super().__init__(**kwargs)
...
class QXCNot(QXBool):
    ...
    def __init__(self, next: QXBool, **kwargs):
        super().__init__(**kwargs)
        self._next = next
...
class QXComp(QXBool):
    ...
    def __init__(self, op: str, left: QXAExp, right: QXAExp, **kwargs):
        super().__init__(**kwargs)
        self._op = coerceStr(op)
        self._left = left
        self._right = right
...
class QXAll(QXSpec):
    ...
    def __init__(self, bind: QXBind, bounds: QXComp, next: QXSpec, **kwargs):
        super().__init__(**kwargs)
        self._bind = bind
        self._bounds = bounds
        self._next = next
...
class QXQIndex(QXQBool, QXAExp):
    ...
    def __init__(self, id: str, index: QXAExp, **kwargs):
        super().__init__(**kwargs)
...
class QXIfExp(QXAExp):
    ...
    def __init__(self, bexp: QXBExp, left: QXAExp, right: QXAExp, **kwargs):
        super().__init__(**kwargs)
        self._bexp = bexp
        self._left = left
        self._right = right
...
class QXQRange(QXTop):
    ...
    def __init__(self, location: str, index: QXAExp = None, crange: QXCRange = None, **kwargs):
        super().__init__(**kwargs)
...
class QXCon(QXTop):
    ...
    def __init__(self, id: str, crange: QXCRange, condition: QXBExp, **kwargs):
        super().__init__(**kwargs)
        self._id = id.getText() if isAntlrNode(id) else id
        self._crange = crange
...
class QXUni(QXAExp):
    ...
    def __init__(self, op: str, next:QXAExp, **kwargs):
        super().__init__(**kwargs)
        self._op = op.getText() if isAntlrNode(op) else op
        self._next = next
...
class QXNum(QXAExp):
    ...
    def __init__(self, num: Union[float, int], **kwargs):
        super().__init__(**kwargs)
        self._num = num
...
class QXSet(QXAExp):
    ...
    def __init__(self, members: [QXAExp], **kwargs):
        super().__init__(**kwargs)
...
class QXMemberAccess(QXAExp):
    ...
    def __init__(self, ids: [str], **kwargs):
        super().__init__(**kwargs)
        self._ids = ids
...
class QXNegation(QXAExp):
    ...
    def __init__(self, aexp: QXAExp, **kwargs):
        super().__init__(**kwargs)
        self._aexp = aexp
...
class QXSumAExp(QXAExp):
    ...
    def __init__(self, sum: QXCon, aexp: QXAExp, **kwargs):
        super().__init__(**kwargs)
        self._sum = sum
        self._aexp = aexp
...
class QXQComp(QXQBool):
    ...
    def __init__(self, op: str, left:QXAExp, right: QXAExp, index: QXQIndex, **kwargs):
        super().__init__(**kwargs)
        self._op = op.getText() if isAntlrNode(op) else op
        self._left = left
        self._right = right
...
class QXQNot(QXQBool):
    ...
    def __init__(self, next: QXQBool, **kwargs):
        super().__init__(**kwargs)
        self._next = next
...
class QXSKet(QXKet):
    ...
    def __init__(self, vector: QXQExp, negative: bool = False, **kwargs):
        super().__init__(**kwargs)
        self._vector = vector
...
class QXVKet(QXKet):
    ...
    def __init__(self, vector: QXAExp, **kwargs):
        super().__init__(**kwargs)
        self._vector = vector
...
class QXOracle(QXExp):
    ...
    def __init__(self, bindings: [QXBind], amp: QXAExp, kets: [QXKet], inverse: bool = False, **kwargs):
        super().__init__(**kwargs)
...
class QXTensor(QXQState):
    ...
    def __init__(self, kets: [QXKet], id: str = None, crange: QXCRange = None, amp: QXAExp = None, **kwargs):
        super().__init__(**kwargs)
        self._kets = kets
        self._id = id.getText() if isAntlrNode(id) else id
        self._crange = crange
...
class QXAssert(QXStmt):
    ...
    def __init__(self, spec: QXSpec, **kwargs):
        super().__init__(**kwargs)
        self._spec = spec
...
class QXCast(QXStmt):
    ...
    def __init__(self, qty :QXQTy, locus: [QXQRange], **kwargs):
        super().__init__(**kwargs)
        self._qty = qty
        self._locus = locus
...
class QXInit(QXStmt):
    ...
    def __init__(self, binding: QXBind, **kwargs):
        super().__init__(**kwargs)
...
class QXCAssign(QXStmt):
    ...
    def __init__(self, ids: [Union[QXBind, QXQIndex]], expr : QXAExp, **kwargs):
        super().__init__(**kwargs)
        self._ids = ids
        self._expr = expr
...
class QXQAssign(QXStmt):
    ...
    def __init__(self, location: Union[list[QXQRange], str], expr : QXExp, **kwargs):
        '''
...
class QXQCreate(QXStmt):
    ...
    def __init__(self, qrange: QXQRange, size: QXAExp, **kwargs):
        super().__init__(**kwargs)
        self._qrange = qrange
        self._size = size
...
class QXMeasure(QXStmt):
    def __init__(self, ids: [QXBind | QXQIndex], locus: Union[str, list[QXQRange]], res: QXAExp = None, **kwargs):
        super().__init__(**kwargs)
        self._ids = ids
        self._locus = locus
        self._res = res
...
class QXMeasureAbort(QXStmt):
    ...
    def __init__(self, ids: str, locus: list[QXQRange], res: QXAExp = None, **kwargs):
        super().__init__(**kwargs)
        self._ids = ids
        self._locus = locus
        self._res = res
...
@qafny.auto.equality
class QXIf(QXStmt):
    def __init__(self, bexp: QXBExp, stmts: [QXStmt], else_branch: [QXStmt], **kwargs):
        super().__init__(**kwargs)
        self._bexp = bexp
        self._stmts = stmts
...
class QXFor(QXStmt):
    ...
    def __init__(self, id: str, crange: QXCRange, conds: [QXCond], stmts: [QXStmt], **kwargs):
        super().__init__(**kwargs)
        self._id = id.getText() if isAntlrNode(id) else id
        self._crange = crange
        self._conds = conds
...
class QXWhile(QXStmt):
    ...
    def __init__(self, bexp: QXBExp, conds: [QXCond], stmts: [QXStmt], **kwargs):
        super().__init__(**kwargs)
        self._bexp = bexp
        self._conds = conds
        self._stmts = stmts
...
class QXCall(QXStmt, QXAExp):
    ...
    def __init__(self, id: str, exps: [QXAExp], inverse: bool = False, **kwargs):
        super().__init__(**kwargs)
        self._id = id.getText() if isAntlrNode(id) else id
        self._exps = exps
        self._inverse = inverse
...
class QXPartPredicate(QXTop):
    ...
    def __init__(self, amplitude: QXAExp, predicate: QXBExp, **kwargs):
        super().__init__(**kwargs)
...
class QXPartsection(QXTop):
    ...
    def __init__(self, amplitude: QXAExp, ket: QXSKet, predicate: QXCall, **kwargs):
        super().__init__(**kwargs)
        self._amplitude = amplitude
        self._ket = ket
...
class QXPart(QXQState):
    ...
    def __init__(self, num : QXAExp, fname: QXAExp, tamp: QXAExp, famp : QXAExp, **kwargs):
        super().__init__(**kwargs)
        self._num = num
        self._fname = fname
        self._tamp = tamp
...
class QXPartWithPredicates(QXQState):
    ...
    def __init__(self, num: QXAExp | None, true_predicate: QXPartPredicate, false_predicate: QXPartPredicate, **kwargs):
        super().__init__(**kwargs)
        self._num = num
...
class QXPartGroup(QXQState):
    ...
    def __init__(self, fpred: str, bool_lit: QXBoolLiteral, amplitude: QXAExp, **kwargs):
        super().__init__(**kwargs)
...
class QXPartLambda(QXQState):
    ...
    def __init__(self, fpred: str, amplitude: QXAExp, **kwargs):
        super().__init__(**kwargs)
        self._fpred = fpred.getText() if isAntlrNode(fpred) else fpred
        self._amplitude = amplitude
...
class QXPartWithSections(QXQState):
    ...
    def __init__(self, sections: [QXPartsection], **kwargs):
        super().__init__(**kwargs)
...
class QXQSpec(QXSpec):
    ...
    def __init__(self, locus: [QXQRange], qty: QXType, states: [QXQState], **kwargs):
        super().__init__(**kwargs)
        self._locus = locus
        self._qty = qty
        self._states = states
...
class QXDecreases(QXCond):
    ...
    def __init__(self, arith_expr: QXAExp, **kwargs):
        super().__init__(**kwargs)
...
class QXSeparates(QXCond):
    ...
    def __init__(self, locus: [QXQRange], **kwargs):
        super().__init__(**kwargs)
        self._locus = locus
...
class QXMethod(QXTop):
    ...
    def __init__(self, id: str, axiom: bool, bindings: [QXBind], returns: [QXBind], conds: [QXCond], stmts: [QXStmt], **kwargs):
        super().__init__(**kwargs)
        self._id = id.getText() if isAntlrNode(id) else id
        self._axiom = axiom
        self._bindings = bindings
...
class QXFunction(QXTop):
    ...
    def __init__(self, id: str, axiom: bool, bindings: [QXBind], return_type: QXQTy, arith_expr: QXAExp, **kwargs):
        super().__init__(**kwargs)
        self._id = id.getText() if isAntlrNode(id) else id
        self._axiom = axiom
        self._bindings = bindings
...
class QXLemma(QXTop):
    ...
    def __init__(self, id: str, axiom: bool, bindings: [QXBind], conds: [QXCond], **kwargs):
        super().__init__(**kwargs)
        self._id = id.getText() if isAntlrNode(id) else id
        self._axiom = axiom
        self._bindings = bindings
...
class QXPredicate(QXTop):
    ...
    def __init__(self, id: str, bindings: [QXBind], arith_expr: QXAExp, **kwargs):
        super().__init__(**kwargs)
        self._id = id.getText() if isAntlrNode(id) else id
        self._bindings = bindings
        self._arith_expr = arith_expr
...
class QXProgram(QXTop):
    ...
    def __init__(self, exps: [QXTop], **kwargs):
        super().__init__(**kwargs)
        self._exps = exps
